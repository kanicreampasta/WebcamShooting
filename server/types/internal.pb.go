...
type DamageInternal struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	DamagedBy string  `protobuf:"bytes,1,opt,name=damagedBy,proto3" json:"damagedBy,omitempty"`
	Amount    float32 `protobuf:"fixed32,2,opt,name=amount,proto3" json:"amount,omitempty"`
}

func (x *DamageInternal) Reset() {
	*x = DamageInternal{}
...
func (x *DamageInternal) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DamageInternal) ProtoMessage() {}

func (x *DamageInternal) ProtoReflect() protoreflect.Message {
	mi := &file_internal_proto_msgTypes[0]
...
// Deprecated: Use DamageInternal.ProtoReflect.Descriptor instead.
func (*DamageInternal) Descriptor() ([]byte, []int) {
	return file_internal_proto_rawDescGZIP(), []int{0}
}

func (x *DamageInternal) GetDamagedBy() string {
	if x != nil {
		return x.DamagedBy
	}
	return ""
...
func (x *DamageInternal) GetAmount() float32 {
	if x != nil {
		return x.Amount
	}
	return 0
...
var file_internal_proto_rawDesc = []byte{
	...
	0x12, 0x0e, 0x77, 0x65, 0x62, 0x63, 0x61, 0x6d, 0x73, 0x68, 0x6f, 0x6f, 0x74, 0x69, 0x6e, 0x67,
	0x22, 0x46, 0x0a, 0x0e, 0x44, 0x61, 0x6d, 0x61, 0x67, 0x65, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x6e,
	0x61, 0x6c, 0x12, 0x1c, 0x0a, 0x09, 0x64, 0x61, 0x6d, 0x61, 0x67, 0x65, 0x64, 0x42, 0x79, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x64, 0x61, 0x6d, 0x61, 0x67, 0x65, 0x64, 0x42, 0x79,
	0x12, 0x16, 0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x02,
	0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x30, 0x5a, 0x2e, 0x67, 0x69, 0x74, 0x68,
...
var file_internal_proto_goTypes = []interface{}{
	(*DamageInternal)(nil), // 0: webcamshooting.DamageInternal
}
